...
<frameset rows="90,*" framespacing="0px" frameborder="no">
    ...
    <frameset id="main" cols="170,9,*" framespacing="0px" frameborder="no" >
        <frameset rows="30,*,40" framespacing="0px" frameborder="no" >
			<frame src="<s:url action="left1"/>" scrolling="no"/>
            <frame src="<s:url action="left"/>" scrolling="no"/>
            <frame src="<s:url action="left2"/>" scrolling="no"/>
        </frameset>
        <frame src="<s:url action="control"/>" scrolling="no"/>
        <frame src="<s:url action="right"/>" name="right" scrolling="yes"/>
	</frameset>
</frameset>
</html>