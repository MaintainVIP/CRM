	...
	<table border="0" width="1140px" cellspacing="0" cellpadding="0" id="table1" >
		...
		<tr align="center" >
			...
			<td class="login_msg" width="400">
				...
				<s:form action="StaffAction" namespace="/"  theme="simple">
					...
					<br>
					用户名：<s:textfield name="loginName" cssClass="msg" />
                    <br><br>
					密　码：<s:password name="loginPwd" cssClass="msg" showPassword="true"/>
                    <br><br>
                    &nbsp;
                    &nbsp;
                    &nbsp;
