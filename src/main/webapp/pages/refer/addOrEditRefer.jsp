...
<s:form namespace="/" action="referAction_addOrEdit">
	...
	<table width="89%" class="emp_table"    style="" align="left" cellspacing="0">
	  <tr>
	    ...
	    <%--<td>--%>
	    	<%--&lt;%&ndash; 状态：咨询中&ndash;%&gt;--%>
			<%--<s:property value="@com.lanou.crm.macro.MacroDefinition@REFER_STATUS[status]" />--%>
	    <%--</td>--%>
	  </tr>
	  <tr>
	    <td>电话：</td>
	    <td><s:textfield name="telephone" value="%{telephone}"></s:textfield> </td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	    <td>QQ：</td>
	    <td><s:textfield name="qq" value="%{qq}"></s:textfield></td>
	    <td>&nbsp;</td>
	  </tr>
	  <s:if test="referId">
	  <tr>
	  ...
	  <tr>
	    <td>意向级别：</td>
	    <td>
	    	<s:select list="@com.lanou.crm.macro.MacroDefinition@REFER_INTENTION_LEVEL" name="intentionLevel" headerKey="" headerValue="--- 请选择意向级别 ---"></s:select>
	    </td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	    <td>意向学科：</td>
		  <td>
			  <s:select list="%{#allCourseType}"
						name="courseType.courseTypeId"
						listKey="courseTypeId" listValue="courseName"
						headerKey="" headerValue="----请--选--择----"
						onchange="changeClass(this)" value="%{courseType.courseTypeId}">
			  </s:select>
			  &nbsp;&nbsp;&nbsp;意向班级：
			  <s:if test="%{courseType != null}">
			  <s:select list="%{courseType.clazzes}"
						id="classSelectId"
						name="clazz.classId"
						value="%{clazz.classId}"
						headerKey="" headerValue="----请--选--择----"
	  ...
	  <tr>
	    ...
	    <td align="left">
	    	<s:select list="@com.lanou.crm.macro.MacroDefinition@REFER_SOURCE" name="source" headerKey="" headerValue="--请选择来源--" value="%{source}"></s:select>
	  ...
	  <tr>
	    <td align="left">备注：</td>
	    <td align="left">
	    	<s:textarea cols="60" rows="5" name="remark" value="%{remark}"></s:textarea>
	    </td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
