...
<s:form action="staffAction_addStaff" namespace="/">
...
<table width="88%" border="0" class="emp_table" style="width:80%;">
    ...
    <tr>
        <td width="10%">所属部门：</td>
        <td width="20%">
        <s:select label="所属部门" list="%{#departments}" listKey="depId" listValue="depName" headerKey=""
                  headerValue="----请--选--择----" onchange="showPost(this)" name="post.department.depId"/>
        </td>
        <td width="8%">职务：</td>
        <td width="62%">
        <s:select label="职务" list="post != null ? post.department.posts : {}" name="post.postId" listKey="postId"
                  listValue="postName" headerValue="----请--选--择----" headerKey="" id="postSelect" requiredLabel="true"/>
        </td>
    </tr>
    <tr>
        <td width="10%">入职时间：</td>
        ...
        <s:textfield label="入职时间" name="onDutyDate" readonly="true" value="%{#myDate}"
