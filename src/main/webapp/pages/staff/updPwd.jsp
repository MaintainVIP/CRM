...
<body class="updpwd">
	<s:form action="staffAction_updPwd" namespace="/">
		<table style="width: 200px">
			...
			<tr>
				<td>原始密码：</td>
				<td>
					<s:password name="oldPassword" showPassword="true"/>
			</tr>
			<tr>
				<td>新&nbsp;密&nbsp;码：</td>
				<td>
					<s:password name="newPassword" showPassword="true"/>
			</tr>
			<tr>
				<td>确认密码：</td>
				<td>
					<s:password name="reNewPassword" showPassword="true"/>
			</tr>
			<tr>
				<td colspan="2">
